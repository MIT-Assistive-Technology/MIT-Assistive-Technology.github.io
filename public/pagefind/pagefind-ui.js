;(() => {
	...
	function Ln(n) {
		...
		return {
			c() {
				;((e = C('div')),
					m(e, 'class', 'pagefind-ui__result-thumb pagefind-ui__loading svelte-j9e30'))
			},
			m(t, r) {
				S(t, e, r)
			},
	...
	function Zn(n) {
		...
		return {
			c() {
				;((e = C('div')),
					m(e, 'class', 'pagefind-ui__result-thumb pagefind-ui__loading svelte-4xnkmf'))
			},
			m(t, r) {
				S(t, e, r)
			},
	...
	function ho(n) {
		...
		return {
			...
			p(M, y) {
				;((!u || (y[0] & 524416 && s !== (s = M[20]('placeholder', M[19], M[7])))) &&
					m(r, 'placeholder', s),
					(!u || (y[0] & 524416 && l !== (l = M[20]('placeholder', M[19], M[7])))) &&
						m(r, 'title', l),
					...
					(!u || (y[0] & 524416 && h !== (h = M[20]('search_label', M[19], M[7])))) &&
						m(t, 'aria-label', h),
